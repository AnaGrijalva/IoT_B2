...
class Callback:
  ...
  def connectionLost(self, cause):
    print("default ConexionPerdida", cause)
    self.events.append("Desconectado")

  def messageArrived(self, topicName, payload, qos, retained, msgid):
    print("default PublicacionOk", topicName, payload, qos, retained, msgid)
    return True

  def deliveryComplete(self, msgid):
    print("default deliveryCompleto")

  def advertise(self, address, gwid, duration):
    print("anunciar", address, gwid, duration)
